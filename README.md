# Introduction to Software Engineering: Python Development projects.
This repository showcases a series of projects developed to understand and master the fundamentals of software engineering, focusing on the Object-Oriented Programming (OOP) paradigm and Pythonic design patterns.

## ⚠️ Important Notice
These projects are hosted purely for **portfolio and professional demonstration purposes**. 
* **For University Students:** These materials are not to be used, copied, or referenced for current university coursework. I encourage all students to adhere to their institution's academic integrity policies.
...
* **Program Constructs:** Built the core engine using fundamental logic, loops, and data structures.
...
* **Code Analysis:** Analyzed and integrated with existing code modules to ensure seamless compatibility.
...
* **Languages:** Python
* **Standard Libraries:** `itertools`, `collections`, `inspect`, `random`
* **Libraries:** Pymunk (2D Physics), Tkinter (GUI)
* **Concepts:** Object-Oriented Programming (OOP), Game Loops, Event-Driven Programming.
